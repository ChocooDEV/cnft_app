  ...
  return (
    <div className="flex-grow">
      <footer className="border-t-2 border-[#141414] bg-black hover:text-white absolute w-full bottom-0">
        <div className="ml-12 py-6 mr-12"> {/* Updated padding from py-12 to py-6 */}
          <div className="grid grid-cols-2 md:grid-cols-6 gap-2 md:gap-8 md:space-x-12 relative">
            <div className="flex flex-col col-span-2 mx-4 items-center md:items-start">
              ...
              <div className="mb-1 m-1 sm:text-left place-items-start items-start font-normal tracking-tight text-secondary">
                © 2023 ChocooDEV
              </div>
            </div>
          </div>
